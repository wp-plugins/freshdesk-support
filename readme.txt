...
Freshdesk Official is a seamless way to add your helpdesk account to your website. Supports various useful functions.

==Description==

Freshdesk Official plugin enables users to achieve three important functions:

1. Avoid additional login to helpdesk if the user has already logged in to WordPress(Single Sign On).
...
== Screenshots ==
Screenshot-1 This screen shot shows the plugin settings screen
Screenshot-2 This screen shot shows the convert comments to tickets screen.
Screenshot-3 This screen shot shows the converted comment having the view ticket links.
...
== Upgrade Notice ==
Features
1. Single sign on to Freshdesk for logged-in wordpress users.
2. Feedback widget for wordpress site: Comes back as ticket
3. Converting wordpress comments into helpdesk tickets
